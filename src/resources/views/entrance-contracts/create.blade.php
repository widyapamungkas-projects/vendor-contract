@extends('layouts.app')
@section('title', 'Add Entrance Ticket')
@section('content')
<div class="flex items-center gap-3 mb-6">
    <a href="{{ route('entrance-contracts.index') }}" class="text-gray-500 hover:text-gray-700">
        <i class="fa-solid fa-arrow-left"></i>
    </a>
    <h1 class="text-2xl font-bold text-gray-800">Add Entrance Ticket</h1>
</div>
<form method="POST" action="{{ route('entrance-contracts.store') }}">
    @csrf
    @include('entrance-contracts._form')
