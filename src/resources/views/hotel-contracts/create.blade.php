...
<div class="flex items-center gap-3 mb-6">
    ...
    <h1 class="text-2xl font-bold text-gray-800">{{ __('contracts.create') }}</h1>
</div>

<form method="POST" action="{{ route('hotel-contracts.store') }}">
    @csrf
    ...
    <div class="flex gap-3 mt-6">
        ...
        <a href="{{ route('hotel-contracts.index') }}" class="px-6 py-2 rounded border hover:bg-gray-50">
            {{ __('contracts.cancel') }}
        </a>
    </div>
</form>
